...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "Static personal site built with Next.js, React, TypeScript, and Tailwind CSS. Includes a UNIX-style terminal, an in-browser WebLLM chat, and MDX posts. Deployed on GitHub Pages.",
    date: "November 2024",
    category: "web-dev",
