...
export default function ProvidencePage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <h1 className="text-4xl font-bold mb-4 text-center">Dueler's Providence</h1>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2">
              <li><a href="https://aksheyd.itch.io/providence" target="_blank" rel="noopener noreferrer" className='underline'>itch.io</a></li>
              <li><a href="https://gamejolt.com/games/duelersprovidence0101/988590" target="_blank" rel="noopener noreferrer" className='underline'>Game Jolt</a></li>
              <li><a href="https://www.indiedb.com/games/duelers-providence" target="_blank" rel="noopener noreferrer" className='underline'>IndieDB</a></li>
              <li><a href="https://forums.tigsource.com/index.php?topic=76322.0" target="_blank" rel="noopener noreferrer" className='underline'>TIGSource DevLog</a></li>
              <li><a href="https://www.youtube.com/watch?v=cIawFXmbvVA" target="_blank" rel="noopener noreferrer" className='underline'>Trailer (YouTube)</a></li>
            </ul>
          </CardContent>
        </Card>
