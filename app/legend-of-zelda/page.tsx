  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-1/4 p-6 overflow-y-auto">
        ...
        <h3 className="text-xl font-med mb-4">
          Authors: Akshey Deokule, Nathaniel Luyben
        </h3>
        <p className="text-lg mb-4">
          This is a dungeon inspired by the first dungeon in the original Legend
          of Zelda. It is built using Unity, C#, and Photoshop.
        </p>
        <p className="text-lg mb-4">
          I developed most of the player movement, weapons, health system,
          combat mechanics, animations/visuals, weapons, and half the enemies.
          Nate mostly focused on the map including navigation and construction
          as well as the collectible system, cheats, audio, and the other half
          the enemies. That all being said, it was a team effort and we worked
          together on most tasks to bring the game together!
        </p>
      </div>
      {/* Game Section */}
